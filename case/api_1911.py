...
class RunTest(TestCase, Tools, system, ipam, ddi_api, resource):
    ...
    def test_ipam_delete_ip_addr_status(self):
        ...
        ip = "192.168.16.5"
        self.addr_status_configure_addr_switch_information(ipsegment=ipsegment,ip=ip)

        sleep(1.5)
        url = "https://" + self.serverip[0] + ":19393/api/ipam/ipstatus/name"

        print('Step2: 在postman上面 DELETE https://192.168.16.109:19393/api/ipam/ipstatus/name?ipSegment=192.168.16.0/24&ip=192.168.16.100,删除指定的ip地址状态')
        payload2 = {
                    "ipSegment": "192.168.16.0/24",
                    "ip":ip,
                    }
