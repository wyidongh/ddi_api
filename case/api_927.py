...
class RunTest(TestCase, Tools, resource, dhcp, ipam, ddi_api,system):
    ...
    def test_add_dhcp_subnet_dns_validation_check(self):

        url = "https://" + self.serverip[0] + ":19393/api/dhcp/subnet"

        print('Step1: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为ipv4的策略，dns字段不合法')
        ip1 = "192.168.1.0"
        mask1 = 24
        ...
        print('Step2: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为ipv4的策略，dns字段不合法')
        ip2 = "192.168.2.0"
        mask2 = 24
        ...
        print('Step3: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为ipv4的策略，dns字段不合法')
        ip3 = "192.168.3.0"
        mask3 = 24
        ...
        print('Step4: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为ipv6的策略，dns字段不合法')
        ip4 = "2001::"
        mask4 = 64
        gateway4 = "2001::1"
        dns4 = "2001::1::2"
        ...
        print('Step5: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为ipv6的策略，dns字段不合法')
        ip5 = "2002::"
        mask5 = 64
        gateway5 = "2002::1"
        dns5 = "1111:2222:3333:4444:5555:6666"
        payload5 = {
            "nodeName": self.dhcpnode[0],
            "ip": ip5,
            "mask": mask5,
        ...
        print('Step6: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为ipv6的策略，dns字段不合法')
        ip6 = "2003::"
        mask6 = 64
        gateway6 = "2003::1"
        dns6 = "1111:2222:3333:4444:5555:6666:7777:8888:9999"
        payload6 = {
            "nodeName": self.dhcpnode[0],
            "ip": ip6,
            "mask": mask6,
        ...
        print('Step7: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为ipv6的策略，dns字段不合法')
        ip7 = "2004::"
        mask7 = 64
        gateway7 = "2004::1"
        dns7 = "1111:222g:3333:4444:5555:6666:7777:8888"
        payload7 = {
            "nodeName": self.dhcpnode[0],
            "ip": ip7,
            "mask": mask7,
        ...
        print('Step8: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为ipv6的策略，dns字段为空')
        ip8 = "2005::"
        mask8 = 64
        gateway8 = "2005::1"
        dns8 = ""
        ...
        print('Step9: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为ipv6的策略，dns字段有多个ip')
        ip9 = "192.168.9.0"
        mask9 = 24
        gateway9 = "192.168.9.1"
        dns9 = "192.168.9.2,192.168.9.3,192.168.9.4"
        payload9 = {
            "nodeName": self.dhcpnode[0],
            "ip": ip9,
            "mask": mask9,
