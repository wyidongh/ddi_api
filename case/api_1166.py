...
class RunTest(TestCase, Tools, resource, dhcp, ipam, ddi_api,system):
    ...
    def test_delete_specific_dhcp_subnet_with_ip_segment(self):
        ...
        ip2 = "10.0.0.0"
        mask2 = "8"
        #self.ipSegment_management_add_ip_segment(ip=ip2, type="IPV4", mask=mask2)
        ip_segment2 = ip2 + "/" + mask2
        #self.ipSegment_configure_configrure_ip_segment(ipsegment=ip_segment2, gateway="10.0.0.1", dns="10.0.0.2")
        #self.business_configure_bind_segment(node=self.dhcpnode[0], segment=ip_segment2)
        ...
        ip3 = "192.168.3.0"
        mask3 = "24"
        # self.ipSegment_management_add_ip_segment(ip=ip3, type="IPV4", mask=mask3)
        ip_segment3 = ip3 + "/" + mask3
        # self.ipSegment_configure_configrure_ip_segment(ipsegment=ip_segment3, gateway="192.168.3.1", dns="192.168.3.2")
        # self.business_configure_bind_segment(node=self.dhcpnode[1], segment=ip_segment3)
        ...
        print('Step1: 用DELETE方法调用接口https://192.168.16.109:19393/api/dhcp/subnet/name?nodeName=dhcp1&ip=192.168.1.0&mask=24查询存在的指定ip段的subnet')
        payload1 = {
            "nodeName": self.dhcpnode[0],
            "ip": ip1,
            "mask": mask1
        ...
        print('Step2: 用DELETE方法调用接口https://192.168.16.109:19393/api/dhcp/subnet/name?nodeName=dhcp1&ip=10.0.0.0&mask=8查询存在的指定ip段的subnet')
        payload2 = {
            "nodeName": self.dhcpnode[0],
            "ip": ip2,
            "mask": mask2
        ...
        print('Step3: 用DELETE方法调用接口https://192.168.16.109:19393/api/dhcp/subnet/name?nodeName=dhcp2&ip=192.168.3.0&mask=24查询存在的指定ip段的subnet')
        payload3 = {
            "nodeName": self.dhcpnode[1],
            "ip": ip3,
            "mask": mask3
        ...
        print('Step4: 用DELETE方法调用接口https://192.168.16.109:19393/api/dhcp/subnet/name?nodeName=dhcp2&ip=1.2.0.0&mask=16查询存在的指定ip段的subnet')
        payload4 = {
            "nodeName": self.dhcpnode[1],
            "ip": ip4,
            "mask": mask4
        ...
        # self.ipSegment_management_add_ip_segment(ip=ip1, type="IPV4", mask=mask1)
        #ip_segment1 = ip1 + "/" + str(mask1)
        # self.path_click('//*[@id="menuid"]/nav/ul/li[1]/a')
        # self.ipSegment_configure_configrure_ip_segment(ipsegment=ip_segment1, gateway="192.168.1.1", dns="192.168.1.2")
        # self.business_configure_bind_segment(node=self.nodename[0], segment=ip_segment1)
        ...
        print('Step5: 用DELETE方法调用接口https://192.168.6.82:19393/api/dhcp/subnet/name?ip=192.168.1.0&mask=24查询存在的指定ip段的subnet')
        payload5 = {
            "ip": ip1,
            "mask": mask1
        }
        ...
        print('Step6: 用DELETE方法调用接口https://192.168.16.109:19393/api/dhcp/subnet/name?nodeName=dhcp3&ip=192.168.1.0&mask=24查询存在的指定ip段的subnet')
        payload6 = {
            "nodeName": "dhcp3",
            "ip": ip1,
            "mask": mask1
        ...
        print('Step7: 用DELETE方法调用接口https://192.168.16.109:19393/api/dhcp/subnet/name?nodeName=dhcp1&ip=192.168.8.0&mask=24查询存在的指定ip段的subnet')
        payload7 = {
            "nodeName": self.dhcpnode[0],
            "ip": "192.168.8.0",
            "mask": "24"
        ...
        print('Step8: 用DELETE方法调用接口https://192.168.16.109:19393/api/dhcp/subnet/name?nodeName=dhcp1&ip=192.168.266.0&mask=24查询存在的指定ip段的subnet')
        payload8 = {
            "nodeName": self.dhcpnode[0],
            "ip": "192.168.256.0",
            "mask": "24"
        ...
        print('Step9: 用DELETE方法调用接口https://192.168.16.109:19393/api/dhcp/subnet/name?nodeName=dhcp1&ip=192.168.1.0&mask=55')
        payload9 = {
            "nodeName": self.dhcpnode[0],
            "ip": "192.168.1.0",
            "mask": "33"
        ...
        print('Step10: 用DELETE方法调用接口https://192.168.16.109:19393/api/dhcp/subnet/name?nodeName=dhcp1&ip=192.168.1.0&mask=32')
        payload10 = {
            "nodeName": self.dhcpnode[0],
            "ip": "192.168.1.0",
            "mask": "32"
        ...
        print('Step11: 用DELETE方法调用接口https://192.168.16.109:19393/api/dhcp/subnet/name?nodeName=dhcp1&ip=192.168.1.0&mask=20查询存在的指定ip段的subnet')
        payload11 = {
            "nodeName": self.dhcpnode[0],
            "ip": "192.168.1.0",
            "mask": "20"
        ...
        print('Step12: 用DELETE方法调用接口https://192.168.16.109:19393/api/dhcp/subnet/name?nodeName=dhcp1&ip=192.168.1.0&mask=24&gateway=192.168.1.2查询存在的指定ip段的subnet')
        payload12 = {
            "nodeName": self.dhcpnode[0],
            "ip": "192.168.1.0",
            "mask": "24",
        ...
        # self.ipSegment_configure_configrure_ip_segment(ipsegment=ip_segment1, gateway="192.168.1.1", dns="192.168.1.2")
        # self.business_configure_bind_segment(node=self.nodename[0], segment=ip_segment1)
        #self.business_configure_bind_segment(node=1, segment=ip_segment1)
        p1 = {
            "nodeName": self.dhcpnode[0],
            "ip": ip1,
            "mask": mask1,
        ...
        print('Step13: 用DELETE方法调用接口https://192.168.16.109:19393/api/dhcp/subnet/name?nodeName=dhcp1&ip=192.168.1.0&mask=24&test=test1查询存在的指定ip段的subnet')
        payload13 = {
            "nodeName": self.dhcpnode[0],
            "ip": "192.168.1.0",
            "mask": "24",
