...
class RunTest(TestCase, Tools, resource, dhcp, ipam, ddi_api,system):
    ...
    def test_add_dhcp_subnet_ipv6_validation_check(self):

        url = "https://" + self.serverip[0] + ":19393/api/dhcp/subnet"

        print('Step1: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为正常的8段的IPV6地址的策略')
        ip1 = "1111:2222:3333:4444:5555:6666:7777:8888"
        mask1 = 128
        gateway1 = "1111::1"
        dns1 = "1111::2"
        payload1 = {
        ...
        print('Step2: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为带有双冒号缩写的IPV6地址的策略')
        ip2 = "2222::6:0"
        mask2 = 64
        gateway2 = "2222::1"
        dns2 = "2222::2"
        ...
        print('Step3: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为::的IPV6地址的策略')
        ip3 = "::"
        mask3 = 128
        gateway3 = "1111::2"
        dns3 = "1111::1"
        ...
        print('Step4: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为包含a-f的IPV6地址的策略')
        ip4 = "333::abef"
        mask4 = 128
        gateway4 = "2001::1"
        dns4 = "2001::2"
        ...
        print('Step5: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为有多个缩写双冒号的错误IPV6地址的策略')
        ip5 = "333::abe::f"
        mask5 = 128
        gateway5 = "2002::1"
        dns5 = "2002::2"
        ...
        print('Step6: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为有少于8段且没有双冒号缩写的错误IPV6地址的策略')
        ip6 = "1111:2222:3333"
        mask6 = 128
        gateway6 = "2003::1"
        dns6 = "1111::1"
        ...
        print('Step7: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为某个label不在0-9和a-f之间的错误IPV6地址的策略')
        ip7 = "ga-12:2222:3333:4444:5555:6666:7777:8888"
        mask7 = 128
        gateway7 = "2004::1"
        dns7 = "1111::1"
        payload7 = {
        ...
        print('Step8: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为正确的IPV6地址的策略，mask不合法')
        ip8 = "2008::"
        mask8 = 0
        gateway8 = "2005::1"
        dns8 = "2008::1"
        ...
        print('Step9: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为正确的IPV6地址的策略，mask不合法')
        ip9 = "2009::0"
        mask9 = 129
        gateway9 = "2009::1"
        dns9 = "2009::2"
