...
class RunTest(TestCase, Tools, system, ipam, ddi_api, resource):
    ...
    def test_ipam_get_addr_status_list_validation_check(self):
        ...
        url = "https://" + self.serverip[0] + ":19393/api/ipam/ipstatus"

        print('Step2: 在postman上面 GET https://192.168.16.109:19393/api/ipam/ipstatus？ipSegment=192.168.345.0/24,获取地址状态ip列表')

        payload2 = {"ipSegment":"192.168.345.0/24"}
        ...
        print('Step3: 在postman上面 GET https://192.168.16.109:19393/api/ipam/ipstatus？ipSegment=192.168.1.0/24,获取地址状态ip列表')

        payload3 = {"ipSegment": "192.168.1.0/24"}
        ...
        print('Step4: 在postman上面 GET https://192.168.16.109:19393/api/ipam/ipstatus？ipSegment=192.168.16.0/24&ip=192.168.16.255,获取地址状态ip列表')
        ...
        print('Step5: 在postman上面 GET https://192.168.16.109:19393/api/ipam/ipstatus？ipSegment=192.168.16.0/24&ip=192.168.16.15,获取地址状态ip列表')
