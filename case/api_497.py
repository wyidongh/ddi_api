...
class RunTest(TestCase, Tools, ddi_api, system, dnspage, resource):
    ...
    def test_add_auth_record_weight_validation_check(self):
        ...
        print('Step3: 用POST方法调用接口https://192.168.6.62:19393/api/dns/records，权重为1')
        payload3 = {
                    "domain": domain1,
                    "host": "b1",
                    "result": {"data": "1.1.1.1"},
        ...
        print('Step4: 用POST方法调用接口https://192.168.6.62:19393/api/dns/records，权重为2')
        payload4 = {
                    "domain": domain1,
                    "host": "b2",
                    "result": {"data": "1.1.1.1"},
        ...
        print('Step5: 用POST方法调用接口https://192.168.6.62:19393/api/dns/records，权重为254')
        payload5 = {
                    "domain": domain1,
                    "host": "b3",
                    "result": {"data": "1.1.1.1"},
        ...
        print('Step6: 用POST方法调用接口https://192.168.6.62:19393/api/dns/records，权重为-1')
        payload6 = {
                    "domain": domain1,
                    "host": "b4",
                    "result": {"data": "1.1.1.1"},
        ...
        print('Step7: 用POST方法调用接口https://192.168.6.62:19393/api/dns/records，权重为0')
        payload7 = {
                    "domain": domain1,
                    "host": "b5",
                    "result": {"data": "1.1.1.1"},
        ...
        print('Step8: 用POST方法调用接口https://192.168.6.62:19393/api/dns/records，权重为255')
        payload8 = {
                    "domain": domain1,
                    "host": "b6",
                    "result": {"data": "1.1.1.1"},
