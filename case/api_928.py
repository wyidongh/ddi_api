...
class RunTest(TestCase, Tools, resource, dhcp, ipam, ddi_api,system):
    ...
    def test_add_dhcp_subnet_lease_validation_check(self):

        url = "https://" + self.serverip[0] + ":19393/api/dhcp/subnet"

        print('Step1: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为ipv4的策略，lease字段合法')
        ip1 = "192.168.1.0"
        mask1 = 24
        ...
        print('Step2: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为ipv4的策略，lease字段合法')
        ip2 = "192.168.2.0"
        mask2 = 24
        ...
        print('Step3: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为ipv4的策略，lease字段不合法')
        ip3 = "192.168.3.0"
        mask3 = 24
        ...
        print('Step4: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为ipv4的策略，lease字段不合法')
        ip4 = "192.168.4.0"
        mask4 = 24
        ...
        print('Step5: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为ipv4的策略，lease字段不合法不是5的整数倍')
        ip5 = "192.168.5.0"
        mask5 = 24
        gateway5 = "192.168.5.1"
        dns5 = "192.168.5.2"
        payload5 = {
            "nodeName": self.dhcpnode[0],
            "ip": ip5,
        ...
        print('Step6: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为ipv4的策略，lease字段不合法不是5的整数倍')
        ip6 = "192.168.6.0"
        mask6 = 24
        gateway6 = "192.168.6.1"
        dns6 = "192.168.6.2"
        payload6 = {
            "nodeName": self.dhcpnode[0],
            "ip": ip6,
        ...
        print('Step7: 用POST方法调用接口https://192.168.6.82:19393/api/dhcp/subnet，添加nodeName为“dhcp1”，ip为ipv4的策略，lease字段不合法')
        ip7 = "192.168.7.0"
        mask7 = 24
        gateway7 = "192.168.7.1"
        dns7 = "192.168.7.2"
        payload7 = {
            "nodeName": self.dhcpnode[0],
            "ip": ip7,
